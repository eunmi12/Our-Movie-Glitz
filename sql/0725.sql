...
insert into movie values (1,'2024-07-01 09:00','2024-07-01 12:00','공포','(대충 진짜 어마무시하게 무섭다는 내용)','짱짱 무서운 영화',15000,1,'김공포','영화 포스터','영화 상세 이미지',null,null,null,null,15);
insert into movie values (2,'2024-07-01 13:00','2024-07-01 15:00','애니메이션','(대충 진짜 어마무시하게 흥미롭다는 내용)','짱짱 꿈과 희망이 넘치는 애니메이션',15000,2,'김애니','영화 포스터','영화 상세 이미지',null,null,null,null,12);
insert into movie values (3,'2024-07-01 16:00','2024-07-01 18:00','모험','(대충 진짜 어마무시한 사바나 평원을 누비는 내용)','짱짱 가슴이 웅장해지는 영화',15000,3,'김자연','영화 포스터','영화 상세 이미지',null,null,null,null,1);
insert into movie values (4,'2024-07-01 20:00','2024-07-01 22:00','범죄','(대충 여썰고 저썰고 하는 내용)','짱짱 잔인해서 눈도 못뜨는 영화',15000,4,'김신체분해','영화 포스터','영화 상세 이미지',null,null,null,null,19);
...
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (2,2,'a1,a2',1,2,30000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (3,2,'b1,b2,b3',1,3,45000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (4,4,'b5',1,1,15000,'2024-07-24 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (1,1,'a1',0,1,15000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (2,1,"a1,a2",1,2,30000,'2024-07-24 11:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (3,1,"a1,a2,a3,a4",0,4,60000,'2024-07-25 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (4,1,"b1,b2",0,2,30000,'2024-07-25 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (1,2,"b3,b4,b5",0,3,45000,'2024-07-25 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (2,2,'a2',0,1,15000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (3,2,"a3,a4,a5,a6",0,4,60000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (4,2,"a7,a8,a9",0,3,45000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (1,4,"b1,b2,b3",0,3,45000,'2024-07-24 09:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (2,4,"b4,b5",1,2,30000,'2024-07-24 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (3,4,'a1',1,1,15000,'2024-07-25 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (4,4,"a2,a3",1,2,30000,'2024-07-25 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (1,4,"a4,a5,a6,a7",1,4,60000,'2024-07-25 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (2,3,"b1,b2,b3",1,3,45000,'2024-07-25 13:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (3,3,"b4,b5",1,2,30000,'2024-07-25 16:00');
insert into ticket (ticket_user_no,ticket_movie_no,ticket_seat,ticket_type,ticket_cnt,ticket_total_price,ticket_date) values (4,3,"a1,a2,a3",1,3,45000,'2024-07-25 16:00');
...
screen_starttime varchar(50),
screen_endtime varchar(50),
screen_date date,
sc_movie_no int,
sc_cinema_no int,
sc_seat_no int
...
insert into screen (screen_starttime,screen_endtime,screen_date,sc_movie_no,sc_cinema_no) values ('08:00','10:00','2024-07-25',5,1);
insert into screen (screen_starttime,screen_endtime,screen_date,sc_movie_no,sc_cinema_no) values ('11:00','13:00','2024-07-25',5,1);
insert into screen (screen_starttime,screen_endtime,screen_date,sc_movie_no,sc_cinema_no) values ('14:00','16:00','2024-07-25',5,2);
insert into screen (screen_starttime,screen_endtime,screen_date,sc_movie_no,sc_cinema_no) values ('17:00','19:00','2024-07-25',5,2);
insert into screen (screen_starttime,screen_endtime,screen_date,sc_movie_no,sc_cinema_no) values ('20:00','22:00','2024-07-25',5,1);
