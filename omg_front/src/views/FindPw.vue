        ...
        <div class="popup-content">
                <form action="">
                    <div class="form-group">
                        ...
                        <button type="button" class="left-button2" @click="switchToIdModal"  >아이디 찾기</button>
                    </div>
                </form>
            <h2>비밀번호 찾기</h2>
            <form @submit.prevent="checkPassword">
                <div class="form-group">
                    ...
                    <input type="text" id="user_id" v-model="user_id" name="user_id" required>
...
export default {
    ...
    methods: {
        ...
        async checkPassword(){
            ...
            try{
                const response = await axios.post(`http://localhost:3000/auth/findPwd`, data, {
                    headers: {
